...
# url shortner
SHORT_URL = environ.get("bindaaslinks.com")
SHORT_API = environ.get("d124a5ac9a4390c23d14213502d80f3525bafde4")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001818683100')).split()]
